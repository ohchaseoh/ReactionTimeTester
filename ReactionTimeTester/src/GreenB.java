...
public class GreenB implements MouseListener {
	...
	//constructor
	public GreenB(String filename){ //constructor requires filename of image
		...
		ImageIcon GreenB = new ImageIcon(src+filename); //setups icon image
		icon = new JLabel(GreenB);
