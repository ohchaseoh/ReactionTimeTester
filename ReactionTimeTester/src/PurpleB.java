...
public class PurpleB implements MouseListener{
	...
	//constructor
	public PurpleB(String filename){ //constructor requires filename of image
		...
		ImageIcon PurpleB = new ImageIcon(src+filename); //setups icon image
		icon = new JLabel(PurpleB);
